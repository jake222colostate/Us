...
const Likes = () => {
  ...
  const received = React.useMemo(() => data?.received ?? [], [data?.received]);
  const sent = React.useMemo(() => data?.sent ?? [], [data?.sent]);
                    ...
                    <Card key={like.id} className="p-4">
                      <div className="flex items-center gap-4">
                        <Avatar className="h-16 w-16 border-2 border-primary">
                          <AvatarImage src={like.user.avatarUrl} alt={like.user.name} loading="React.lazy" />
